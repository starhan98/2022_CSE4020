...
def log(R):
    ...
    v1 = (R[2][1] - R[1][2])/(2*np.sin(t))
    v2 = (R[0][2] - R[2][0])/(2*np.sin(t))
    v3 = (R[1][0] - R[0][1])/(2*np.sin(t))
    v = t * np.array([v1,v2,v3])
    return v
...
def interpolateZYXEuler(euler1, euler2, t):
    ...
    # return lerp(ZYXEulerToRotMat(euler1), ZYXEulerToRotMat(euler2), t)
